...
export default function FriendItemView(props) {
  ...
  return (
    <>
      <div class="card d-flex align-items-center justify-content-center flex-column" style={{"width": "14rem",marginLeft:"5px",marginBottom:"10px",backgroundColor:"rgb(179, 177, 177)"}}>
  ...
  <div class="card-body">
    ...
    <button className='btn mb-2 mx-2' style={{backgroundColor:"black",color:"aquamarine"}} onClick={removeFollower}>REMOVE</button>
  </div>
</div>
    </>
  )
